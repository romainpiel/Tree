...
exports.followers = function(req, callback) {
    ...
    request.get(APPNET_URL + '/users/' + userId + '/followers/ids?' + qs.stringify(params), function(err, resp, body) {
...
exports.following = function(req, callback) {
    ...
    request.get(APPNET_URL + '/users/' + userId + '/following/ids?' + qs.stringify(params), function(err, resp, body) {
